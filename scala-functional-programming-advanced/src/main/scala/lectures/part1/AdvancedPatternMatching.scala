...
object AdvancedPatternMatching extends App {
  ...
  // infix patterns
  case class Or[A, B](a: A, b: B) // in scala this is Either, using own type Or for demonstration
  val either = Or(2, "two")
  val humanDescription = either match {
    //case number Or string => s"$number is written as $string" // gives warning
